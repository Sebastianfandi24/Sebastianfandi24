...
Soy desarrollador con experiencia en Python, Java, Django, y tecnologías web (HTML, CSS, JavaScript). Tengo conocimientos avanzados en bases de datos con PostgreSQL y manejo de versiones con Git. Estoy enfocado en seguir aprendiendo y mejorar mis habilidades en desarrollo de software.
